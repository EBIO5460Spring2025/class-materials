...
```
    ...
    ## Warning in geom_point(aes(x = x_new, y = y_pred), col = "red"): All aesthetics have length 1, but the data has 22 rows.
...
model. Be careful not to confuse the k’s! There is the k-fold k and the
KNN k.
