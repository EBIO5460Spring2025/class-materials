...
#' Gradient descent illustrated with a simple linear model. This is first draft
#' code with a lot of copy-pasted blocks and quick rudimentary plots that I used
#' to prepare the lecture. I'll clean this up by making functions for repeated
#' components.
